...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-card/95 backdrop-blur-lg border-b border-border animate-[slide-in-right_0.8s_ease-out] shadow-sm">
